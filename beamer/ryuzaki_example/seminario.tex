...
\title{Pendências \textit{Infra} e \textit{Dev}}
...
\frame 
{
  ...
  \begin{itemize}[<+->]
  \item Mostrar o que já foi feito em \textit{Infra} e \textit{Dev} 
    
  \item ...e o que ainda precisa ser feito
  \item Cores 
  \begin{itemize}[<+->]
    \item Preto, o que já foi feito
...
\frame
{
  \frametitle{Samba, Domínio, Backup}
  \begin{itemize}[<+->]
...
\frame
{
  ...
  \item -XMLNuke +Cake
  \begin{itemize}[<+->]
  \item 4 VMs rodando Cake e 1 física
  \item 4 VMs de Cake, aguenta o trafego do JáCotei
  \end{itemize}
  \item Cadastro
  ...
  \item \textcolor{red}{Alterações no Admin ( xmlvitrine, upload de logomarca
  )}
  \item \textcolor{red}{Promoções ( ... ainda em Zend )}
